...
function ascent_content_nav( $nav_id ) {
	...
	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
	    ...
	    <li class="nav-previous previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Siguiente', 'ascent' ) ); ?></li>
	    <?php endif; ?>

	    <?php if ( get_previous_posts_link() ) : ?>
	    <li class="nav-next next"><?php previous_posts_link( __( 'Anterior <span class="meta-nav">&rarr;</span>', 'ascent' ) ); ?></li>
	    <?php endif; ?>
	<?php endif; ?>
	</ul>
