...
<div id="comments" class="comments-area">
	...
	'title_reply'       => __( 'Deja una Respuesta', 'ascent' ),  // that's the wordpress default value! delete it or edit it ;)
	'title_reply_to'    => __( 'Deja una Respeusta a %s', 'ascent' ),  // that's the wordpress default value! delete it or edit it ;)
	'cancel_reply_link' => __( 'Cancelar', 'ascent' ),  // that's the wordpress default value! delete it or edit it ;)
	'label_submit'      => __( 'Comentar', 'ascent' ),  // that's the wordpress default value! delete it or edit it ;)

	'comment_field' =>  '<p><textarea placeholder="Escriba su Comentario aquí..." id="comment" class="form-control" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>',

	'comment_notes_after' => '<p class="form-allowed-tags">' .
	      __( 'Puedes usar las siguientes etiquetas y atributos <abbr title="HyperText Markup Language">HTML</abbr>.', 'ascent' ) .
